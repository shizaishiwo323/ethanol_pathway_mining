...
One-row audit table generated by `scripts/07_calculate_pathway_frequency.py`. It records the final statistics source priority, total paper counts, DeepSeek sentence-review counts, fallback counts, failed-row counts, and conflict-resolution counts.
